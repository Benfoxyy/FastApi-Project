...
class TaskBaseSchema(BaseModel):
    ...
    description: Optional[str] = Field(None, max_length=500, description="Tasks description")
...
class TaskReadSchema(TaskBaseSchema):
    ...
    created_date: datetime = Field(..., description="Exact time that task has been created")
